...
class CP_Shortcode
{
	...
	public function shortcode_form()
	{
		...
		wp_enqueue_script('cp-script-rest');
		wp_enqueue_script('jquery-form');
		wp_enqueue_style('cp-styles');
		wp_enqueue_script('cp-select2-script');
		wp_enqueue_style('cp-select2-style');
...
?>
	...
	function fields_form($key, $args, $value = null)
	{
		...
		if ($args['required']) {
			...
			$required = '&nbsp;<span class="optional"></span>';
		}
		//(' . esc_html__('optional', 'afp') . ')
